...
from_path: narratives/02-vision-mission.md
---
<!-- Rolled up from calmstorm-decks/context-v/narratives/02-vision-mission.md. Edit at the source, not here. Re-run `pnpm rollup:sync` to refresh. -->
