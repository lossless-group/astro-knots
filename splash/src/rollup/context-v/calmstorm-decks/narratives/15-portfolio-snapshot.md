...
from_path: narratives/15-portfolio-snapshot.md
---
<!-- Rolled up from calmstorm-decks/context-v/narratives/15-portfolio-snapshot.md. Edit at the source, not here. Re-run `pnpm rollup:sync` to refresh. -->
