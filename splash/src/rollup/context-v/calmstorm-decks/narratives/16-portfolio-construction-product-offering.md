...
return_thesis_lines:
  ...
  - Leveraging increasing maturity of European HealthTech with growing late-stage capital and buyer activity.
key_stat: "30"
key_stat_label: category-defining startups in Fund III
cta_or_footer: null
sources: []
from: calmstorm-decks
from_path: narratives/16-portfolio-construction-product-offering.md
---
<!-- Rolled up from calmstorm-decks/context-v/narratives/16-portfolio-construction-product-offering.md. Edit at the source, not here. Re-run `pnpm rollup:sync` to refresh. -->
