...
featured_supporting_partners:
  - "{ name: \"Dr. Sievert Weiss\", company: \"Amboss\",  role: \"Co-Founder\" }"
  - "{ name: \"Nora Blum\",         company: \"Selfapy\", role: \"Co-Founder\" }"
  - "{ name: \"Joe Spector\",       company: \"HIMS\",    role: \"Co-Founder\" }"
...
from_path: narratives/12-competitive-advantage.md
---
<!-- Rolled up from calmstorm-decks/context-v/narratives/12-competitive-advantage.md. Edit at the source, not here. Re-run `pnpm rollup:sync` to refresh. -->
